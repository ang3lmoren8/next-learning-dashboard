      ...
      <div className='w-full h-screen flex flex-col items-center justify-center'>
        ...
        <div className='mt-6 flex flex-col items-center justify-center'>
          ...
          <p className='md:text-lg xl:text-xl text-gray-500 mt-4'>
            Sorry, we could find what you were looking for.
          </p>
          <Link href='/dashboard/main' className='mt-6 p-2 min-w-[180px] text-center bg-indigo-600 hover:bg-indigo-900 transition-all rounded-2xl text-white font-bold'>
            Go home
          </Link>
        </div>
      </div>
